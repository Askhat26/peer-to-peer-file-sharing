...
function FileUpload({ onFileUpload, isUploading }) {
    ...
    const { getRootProps, getInputProps } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$dropzone$2f$dist$2f$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useDropzone"])({
        ...
        multiple: false,
        onDragEnter: {
            "FileUpload.useDropzone": ()=>setDragActive(true)
        }["FileUpload.useDropzone"],
        onDragLeave: {
            "FileUpload.useDropzone": ()=>setDragActive(false)
        }["FileUpload.useDropzone"],
        onDropAccepted: {
            "FileUpload.useDropzone": ()=>setDragActive(false)
        }["FileUpload.useDropzone"],
...
_s(FileUpload, "bDT2TvoExXX79qbfJ/kiP3GsOtY=", false, function() {
    return [
...
_s(FileDownload, "RVsABy29253T9K9pgndSfMz1S+M=", true);
_c = FileDownload;
var _c;
...
//# sourceMappingURL=src_app_a394eea4._.js.map